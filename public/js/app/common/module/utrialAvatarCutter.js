define(function(require, exports, module) {
    ...
    require('../../../thirdParty/jquery.Jcrop');
    
    UtrialAvatarCutter = function(config){
        var h,w,x,y;
        ...
        this.reload = function(img_url){
            if(img_url!=null && img_url != ""){
                ...
                var $parent = $("#"+img_content_id);
                $parent.html("<img id='"+img_id+"' src='"+os+"'/>");
        ...
        this.submit = function(){
            ...
            h = Math.round(rx*h);
            x = Math.round(rx*x);
            y = Math.round(ry*y);            return {w:w,h:h,x:x,y:y,s:os.substr(0,os.indexOf('?'))};
        }
    }
    module.exports = UtrialAvatarCutter;
});