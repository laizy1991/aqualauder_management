...
define(function(require) {
    ...
    var Chart = {
        init: function() {
            ...
            this.initForm(getDateArray(getDate(startDate), getDate(endDate)));
            this.dataFilter();
        },

        initForm: function (categoriesArr, startDate, endDate) {
            ...
            //$.getJSON('/Statistics/persistUsers', params, function (res) {});
        ...
        dataFilter: function() {
            ...
            $('#filterBtn').click(function() {
                ...
                //self.initForm(dateArr, startDate, endDate);
                var ch=$('#filter-by-ch').find('option:selected').val().trim();
                var timeId=$('#filter-by-time').find('option:selected').data('id');
