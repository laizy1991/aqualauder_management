...
define(function(require) {
    ...
    var Chart = {
        ...
        initHighcharts: function(categoriesArr, startDate, endDate) {
            ...
            var chartType=$('#chart-type').find('option:selected').val().trim();
            var timeId=$('#filter-by-time').find('option:selected').data('id');
            var params={
                "form.chartFilter":chartType,
            ...
            //$.getJSON(args.url, {'startDate': startDate, 'endDate': endDate}, function (res) {
                ...
                $('#chartWrap').highcharts({
                    ...
                    series: data
                    //series:[{"name":"有收发消息人数统计","data":[28,28,53,32,38,46]},{"name":"有发消息人数统计","data":[27,28,58,33,41,48]},{"name":"发消息总数统计","data":[255,673,311,150,562,572]}]
                });
            });
        },
